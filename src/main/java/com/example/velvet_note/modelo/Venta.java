...
import java.time.LocalDateTime; // Guarda el momento exacto en que se genero la venta.
...
public class Venta {
    ...
    @Override // Cambia la forma en que un codigo se presenta
    public String toString() { // Se convertira un objeto en un mensaje
